...
To install the Play Integrity Fix module, you will need to use either **KSU** (KernelSU) or **Magisk**. Please note that **recovery is unsupported** for this module.

1. **Download the Module**  
   The Play Integrity Fix module can be downloaded using the link at the bottom of this post.

2. **Use KSU or Magistrate**  
   You will need to use either KSU or Magisk for installation. Follow their respective installation procedures to install the module.
