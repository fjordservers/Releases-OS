...
* **Enhanced Compatibility with Play Integrity**  
  This fix resolves issues with apps dependent on Google Play’s Integrity API.
...
2. **Use Magisk or KSU with Zygisk**  
   ...
   - If you are using **KSU**, you will also need to install the **ReZygisk module** for compatibility.
